        ...
        <div class="container-report">
            ...
            <form method="POST" action="{{ route('lapor.store') }}" enctype="multipart/form-data">
                ...
                <select name="okupasi" id="okupasi" class="form-select" required
                    onchange="toggleLainnyaBox(this.value)">
                ...
                <input type="text" name="okupasi_lainnya" id="okupasi_lainnya" class="form-control d-none"
                    placeholder="Isi Okupasi Lainnya...">

                <!-- Email -->
                <label for="email">Email</label>
                <input type="email" name="email" id="email" required placeholder="Contoh: username@example.com">
        ...
        document.getElementById('lampiran').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(evt) {
                    preview.innerHTML =
                        `<img src="${evt.target.result}" style="max-width: 100%; max-height: 100%;">`;
                };
