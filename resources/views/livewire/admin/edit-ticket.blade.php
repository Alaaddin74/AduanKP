    ...
    <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <p class="text-lg text-gray-800 dark:text-gray-100">{{ $ticket->name ?? 'Umum' }}</p>

                <label class="text-sm text-gray-600 dark:text-gray-400">No hp:</label>
                <p class="text-lg text-gray-800 dark:text-gray-100">{{ $ticket->no_hp ?? 'Not available' }}</p>
                ...
                <p class="text-lg text-blue-800 dark:text-gray-100"><a href="{{ $ticket->site_link ?? '-' }}" target="_blank">{{ $ticket->site_link ?? '-' }}</a></p>
            ...
            <div>
                ...
                <textarea wire:model="note" rows="6"
